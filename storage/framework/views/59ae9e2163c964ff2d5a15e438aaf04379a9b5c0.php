...
<div class="title-pg">
    <h1 class="title-pg">Cadastrar Aeroporto para a cidade <?php echo e($city->name); ?></h1>
</div>
...
<div class="content-din">
    ...
    <form class="form form-search form-ds" action="<?php echo e(route('airports.store', $city->id)); ?>" method="POST">    
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('panel.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel58/resources/views/panel/airports/create.blade.php ENDPATH**/ ?>