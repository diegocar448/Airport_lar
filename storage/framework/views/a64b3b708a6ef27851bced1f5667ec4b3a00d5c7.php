...
<html lang="pt-br">
    <head>
        <title><?php echo e($title ?? "Curso EspecializTi"); ?></title>
        <meta charset="UTF-8">
        ...
        <!--Resets-->
        <link href="<?php echo e(url('assets/site/css/reset.css')); ?>" rel="stylesheet">
        ...
        <!--Favicon-->
        <link rel="icon" href="<?php echo e(url('assets/site/images/favicon.png')); ?>" type="image/png">
    </head>
    <body>
        ...
        <?php echo $__env->yieldContent('content-site'); ?>
...
</html><?php /**PATH /var/www/laravel58/resources/views/site/layouts/app.blade.php ENDPATH**/ ?>