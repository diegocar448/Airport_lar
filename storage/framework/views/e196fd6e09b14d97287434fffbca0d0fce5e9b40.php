...
<div class="form-group">
    ...
    <?php if($flight == null): ?>
        <input type="number" value="<?php echo e(old('old_price' ?? '')); ?>" placeholder="preço anterior" name="old_price" class="form-control">
    <?php else: ?>
        <input type="number" value="<?php echo e($flight->old_price ?? old('old_price' ?? '')); ?>" placeholder="preço anterior" name="old_price" class="form-control">
    <?php endif; ?>
</div>
...
<div class="form-group">
    ...
    <?php if($flight == null): ?>
        <input type="number" value="<?php echo e(old('price' ?? '')); ?>" placeholder="Preço" name="price" class="form-control">
    <?php else: ?>
        <input type="number" value="<?php echo e($flight->price ?? old('price' ?? '')); ?>" placeholder="Preço" name="price" class="form-control">
    <?php endif; ?>
</div>
