...
<div class="content-din">
    ...
    <form class="form form-search form-ds" action="{{route('airports.destroy', [$city->id, $airport->id])}}" method="POST">
        {!! method_field('DELETE') !!}         
        {!! csrf_field() !!}    

        <div class="form-group">
            <button class="btn btn-danger">Apagar {{$airport->name}}</button>
        </div>
    <form>
